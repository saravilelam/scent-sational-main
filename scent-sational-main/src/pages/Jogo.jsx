            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 md:px-20   items-center ">
                <section className="bg-white dark:bg-darkbg dark:text-white rounded-[30px] p-10 md:p-30 h-[550px] md:h-[542px]">
                    <H2Subtitulo>
                        ...
                        coletar itens e usar suas habilidades para passar de fase sem que o monstro o alcance, 
                        tornando sua missão ainda mais desafiadora. O objetivo é superar esses obstáculos 
                        para que no final consiga acordar dos sonhos, mostrando de forma lúdica a importância 
                        do autocuidado e da saúde mental.
                    </H2Subtitulo>
                </section>
